...
export class SigninPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private formBuilder: FormBuilder, public storage: Storage, 
    ...
    // console.log('networkStatus', this.serviceProvider.getNetworkType());
    // if(this.serviceProvider.getNetworkType()){
  ...
  fblogin(){
    ...
    if(this.serviceProvider.getNetworkType() == 'none') {
      ...
      let alert = this.alertCtrl.create({
        title: 'Oops!',
        subTitle: "You seem to be offline ! Please Enable network to login in app.",
        buttons: [{
          text: ("Okay")
        }]
      });
