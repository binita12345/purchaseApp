 ...
 */
var OrderproductPage = /** @class */ (function () {
    function OrderproductPage(navCtrl, navParams) {
    ...
    OrderproductPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad OrderproductPage');
    };
    OrderproductPage.prototype.gotoHome = function () {
        // let myDiv = document.getElementById('target1');
        this.navCtrl.push("HomeappPage");
        // document.getElementById("target1").style.background = "#000000";
    };
    OrderproductPage.prototype.gotoCart = function () {
        this.navCtrl.push("CartlistPage");
        // document.getElementById("target2").style.background = "#000000";
    };
    OrderproductPage.prototype.gotoRequestlist = function () {
        this.navCtrl.push("RequestlistPage");
    };
    OrderproductPage.prototype.gotoProfile = function () {
        this.navCtrl.push("ProfilePage");
        // document.getElementById("target4").style.background = "#000000";
    };
    OrderproductPage.prototype.gotoNotification = function () {
    ...
    OrderproductPage.prototype.gotoChangePassword = function () {
        this.navCtrl.push("ChangepasswordPage");
        // document.getElementById("target8").style.background = "#000000";
    };
    OrderproductPage = __decorate([
        IonicPage(),
        Component({
